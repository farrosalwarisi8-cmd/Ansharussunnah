...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-lg px-2.5 py-2 text-sm outline-none transition-colors focus:bg-slate-100 focus:text-slate-800 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 min-h-[40px] sm:min-h-[34px]",
      inset && "pl-8",
      className
    )}
    {...props}
