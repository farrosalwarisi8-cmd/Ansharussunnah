...
export type TagihanSpp = Prisma.TagihanSiswaGetPayload<Record<string, never>>
export type PembayaranSpp = Prisma.PembayaranSiswaGetPayload<Record<string, never>>
