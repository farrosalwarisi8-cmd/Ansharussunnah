...
import { escapeHtmlJsonLd } from "@/lib/html"

const inter = Inter({ subsets: ["latin"], display: "swap", preload: true })

// Font Arab untuk teks nama madrasah di navbar (Naskh = mudah dibaca di layar)
    ...
    <html lang="id" className="scroll-smooth">
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: escapeHtmlJsonLd(jsonLd) }}
        />
      </head>
      <body className={`${inter.className} ${notoNaskhArabic.variable} min-h-screen bg-slate-50/50 antialiased text-slate-800 selection:bg-yellow-100 selection:text-yellow-800`}>
